//_____D1_Epd0154red_BME280_mqtt.ino__________180405-180504_____
// Measure temperature, humidity pressure/altitude with a BME280
// every 15 seconds and display values on a 3-color
...
#include "src/epd/D1_class_Epd_1in54red.h"
...
#define  DELAY_EPD                267            // ms
#define  STATE_MAX                30             // state 0..29
...
void displayValues(String values)
{
 ...
 int x=(200-s1.length()*Font24x11_255.Width)/2;
 if(x<0) x=0;
 ...
 y=y+24;
 epdPainter.drawBigLine(0,y,199,y,RED);
 y=y+2;
 epdPainter.drawStringAt(6,y,"Date & Time:",RED);
 y=y+24;
 epdPainter.drawStringAt(6,y,sDate,RED);
 y=y+24;
 epdPainter.drawStringAt(6,y,sTime,RED);
 //datetime="?";
 //-----display buffer------------------------------------------
