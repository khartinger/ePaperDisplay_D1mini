...
//_____calculate straight line parameter________________________
...
//_____read analog in and return value__________________________
...
//_____set reference point P1___________________________________
int Ain::setRefPoint1(int x1, float y1) {
 return(calcKD(x1, y1, ain_x2, ain_y2));
}

//_____set reference point P2___________________________________
